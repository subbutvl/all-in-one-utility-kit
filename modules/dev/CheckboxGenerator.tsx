      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 flex-1 min-h-0">
        <div className="lg:col-span-5 space-y-4 overflow-y-auto pr-2 pb-10">
          ...
          <div className="grid grid-cols-3 gap-2 mb-2">
            ...
            <button onClick={() => applyPreset('soft')} className="py-2 border border-neutral-800 text-[9px] uppercase font-bold hover:bg-neutral-800 transition-colors">Soft</button>
          ...
          <div className="bg-[#111] border border-neutral-800 p-6 space-y-6">
            <span className="text-[10px] uppercase text-neutral-500 font-bold tracking-widest block mb-2 border-b border-neutral-800 pb-2">Style Configuration</span>
        ...
        <div className="lg:col-span-7 flex flex-col gap-6">
          ...
          <div className="bg-[#111] border border-neutral-800 p-6">
            <div className="flex items-center justify-between mb-4">
              <span className="text-[10px] uppercase text-neutral-600 font-bold tracking-widest">Checkbox CSS</span>

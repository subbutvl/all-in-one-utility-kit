    ...
    <div className="h-full flex flex-col gap-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 flex-1">
        <div className="flex flex-col gap-2">
          <label className="text-[10px] uppercase text-neutral-600 font-bold tracking-widest">Source HTML / Text</label>
          <textarea 
            value={input}
        ...
        <div className="flex flex-col gap-2">
          <label className="text-[10px] uppercase text-neutral-600 font-bold tracking-widest">Processed Result</label>
      ...
      <div className="flex gap-2 py-4 border-t border-neutral-800">
        ...
        <button onClick={() => { setInput(''); setOutput(''); }} className="px-4 py-2 text-neutral-600 hover:text-red-500 text-xs font-bold uppercase tracking-widest transition-colors">Clear</button>
      </div>
    </div>
  );
};
